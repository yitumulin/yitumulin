(function() {
  ...
  const EN_TO_ZH = {
    ...
    "I am a Telecommunication Engineering and Management student at Beijing University of Posts and Telecommunications, seeking internships in LLM application engineering, AI development, and AI product engineering.": "我在北京邮电大学学习电信工程与管理，正在寻找 LLM 应用工程、AI 开发和 AI 产品工程相关实习。",
    "This portfolio is designed for recruiters to evaluate, within 30 seconds, what I built, what I owned, and what measurable outcomes I delivered.": "这个作品集面向招聘方，帮助你在 30 秒内判断我做了什么、负责了什么、产出了哪些可量化结果。",
    ...
    "Core Stack": "核心技术栈",
    "AI Product Engineering": "AI 产品工程",
    ...
    "LLM Application, AI Product Engineering, Computer Vision, BCI, Database": "LLM 应用、AI 产品工程、计算机视觉、BCI、数据库",
